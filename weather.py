...
def get_celsius(kelvin):
    """
        This is created to get celsius with kelvin.
    """
...
def get_response(fname,mcity):
    """
        This is created to get response with base url and api key.
    """
...
def get_elements(mresponse):
    """
        This is created to divide info into many pieces.
    """
...
def showing(mlist,mname,ttrue,htrue,wtrue,dtrue,strue):
    """
        This is created to show the info.
    """
...
def chcking_api_code(mrespond):
    """
        This is created to check api key.
    """
    answer = True
    if mrespond['cod'] == 401:
